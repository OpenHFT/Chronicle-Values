...
| If a symbol is not available in ISO-8859-1, use a textual form such as `>=`, `:alpha:`, `&#x2713;`. This is the preferred approach and Unicode outside Latin-1 must not be inserted. | Extended encodings outside ISO-8859-1 are *not* portable and are therefore disallowed. |
