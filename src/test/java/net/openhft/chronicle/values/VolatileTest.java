...
public class VolatileTest extends ValuesTestCommon {
    ...
    public void testGenerateJavaCode() {
        ...
        jbi2.setOrderedY(5);
        assertEquals(5, jbi2.getVolatileY());
        jbi2.setOrderedIntAt(0, 0);
        jbi2.setOrderedIntAt(1, 1);
        jbi2.setOrderedIntAt(2, 2);
        jbi2.setOrderedIntAt(3, 3);

        assertEquals(0, jbi2.getVolatileIntAt(0));
        assertEquals(1, jbi2.getVolatileIntAt(1));
        assertEquals(2, jbi2.getVolatileIntAt(2));
        assertEquals(3, jbi2.getVolatileIntAt(3));
    }
