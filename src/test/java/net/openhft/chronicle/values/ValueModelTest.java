...
public class ValueModelTest {
    ...
    public void testAcquire() {
        ValueModel<MinimalInterface> midvm = ValueModels.acquireModel(MinimalInterface.class);
        ...
        ValueModel<JavaBeanInterface> jbdvm = ValueModels.acquireModel(JavaBeanInterface.class);
        ...
        ValueModel<NestedArrayInterface> nais = ValueModels.acquireModel(NestedArrayInterface.class);
        ...
        ValueModel<HasArraysInterface> haim = ValueModels.acquireModel(HasArraysInterface.class);
